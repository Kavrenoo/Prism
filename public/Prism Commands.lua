...
PM.Speed = { walkSpeed = 16, cframeSpeed = 0, enabled = false, connection = nil }
...
registerCommand("speed", "WalkSpeed and CFrame speed GUI", {}, function(args)
    ...
    pcall(function()
        ...
        MainFrame.Position = UDim2.new(0, 1142, 0, 477)
        MainFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
        MainFrame.BackgroundTransparency = 0.3
        MainFrame.BorderSizePixel = 0
        MainFrame.ClipsDescendants = true
        ...
        ContentFrame:FindFirstChildOfClass("UIPadding").PaddingBottom = UDim.new(0, 4)
        ContentFrame:FindFirstChildOfClass("UIPadding").PaddingLeft = UDim.new(0, 8)
        ContentFrame:FindFirstChildOfClass("UIPadding").PaddingRight = UDim.new(0, 8)

        -- WalkSpeed
        local function createSlider(parent, label, order, defaultVal, maxVal, callback)
        ...
        createSlider(ContentFrame, "WalkSpeed", 1, PM.Speed.walkSpeed, 200, function(val)
            local speed = math.clamp(math.floor(val), 1, 200)
            PM.Speed.walkSpeed = speed
            local char = LP.Character
        ...
        createSlider(ContentFrame, "CFrame Speed", 2, PM.Speed.cframeSpeed, 10, function(val)
            local speed = math.clamp(math.floor(val * 10) / 10, 0, 10)
            PM.Speed.cframeSpeed = speed
            return string.format("%.1f", speed)
        end)

        if PM.Speed.connection then PM.Speed.connection:Disconnect() end
        PM.Speed.connection = RunService.Heartbeat:Connect(function()
            if PM.Speed.cframeSpeed <= 0 then return end
            local char = LP.Character
            local root = char and char:FindFirstChild("HumanoidRootPart")
            if not root then return end
            local hum = char:FindFirstChildOfClass("Humanoid")
            ...
            if moveDir.Magnitude > 0 then
                root.CFrame = root.CFrame + (moveDir.Unit * PM.Speed.cframeSpeed)
            end
        end)
    end)
end)

registerCommand("jump", "Jump power with infinite jump", {}, function(args)
    local CoreGui = game:GetService("CoreGui")
    local UserInputService = game:GetService("UserInputService")
    local TweenService = game:GetService("TweenService")
    local Players = game:GetService("Players")
    ...
    if guiExists("Prism_JumpGUI") then return end
    ...
    pcall(function()
        ...
        MainFrame.Position = UDim2.new(0, 1142, 0, 660)
        MainFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
        MainFrame.BackgroundTransparency = 0.3
        MainFrame.BorderSizePixel = 0
        MainFrame.ClipsDescendants = true
        ...
        UserInputService.InputChanged:Connect(function(input)
            if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
                ...
                MainFrame.Position = UDim2.new(0, delta.X - 100, 0, delta.Y - 20)
            end
        end)
        ...
        MinBtn.MouseButton1Click:Connect(function()
            ...
            if isMinimized then
                ...
                MinBtn.Text = "—"
                TweenService:Create(MainFrame, tweenInfo, {Size = UDim2.new(0, 260, 0, 140)}):Play()
            end
        end)

        -- Jump Power Slider
        local JumpSection = Instance.new("Frame")
        JumpSection.Size = UDim2.new(1, -16, 0, 50)
        JumpSection.Position = UDim2.new(0, 8, 0, 0)
        JumpSection.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
        JumpSection.BackgroundTransparency = 0.4
        ...
        JumpLabel.Position = UDim2.new(0, 10, 0, 4)
        ...
        JumpSliderBg.Size = UDim2.new(1, -20, 0, 6)
        JumpSliderBg.Position = UDim2.new(0, 10, 0, 28)
        JumpSliderBg.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
        JumpSliderBg.Parent = JumpSection
        Instance.new("UICorner", JumpSliderBg).CornerRadius = UDim.new(0, 3)

        local JumpSliderFill = Instance.new("Frame")
        JumpSliderFill.Size = UDim2.new(0.25, 0, 1, 0)
        JumpSliderFill.BackgroundColor3 = Color3.fromRGB(80, 80, 80)
        JumpSliderFill.Parent = JumpSliderBg
        Instance.new("UICorner", JumpSliderFill).CornerRadius = UDim.new(0, 3)
        ...
        JumpSliderBg.InputBegan:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1 then
                ...
                local power = math.clamp(math.floor(1 + pos * 199), 1, 200)
                JumpLabel.Text = "Jump Power: " .. power
        ...
        IJRow.Size = UDim2.new(1, -16, 0, 32)
        IJRow.Position = UDim2.new(0, 8, 0, 58)
        IJRow.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
        IJRow.BackgroundTransparency = 0.4
        IJRow.Parent = ContentFrame
        Instance.new("UICorner", IJRow).CornerRadius = UDim.new(0, 10)

        local IJLabel = Instance.new("TextLabel")
        IJLabel.Size = UDim2.new(1, -60, 1, 0)
        ...
        IJPill.Size = UDim2.new(0, 40, 0, 22)
        IJPill.Position = UDim2.new(1, -52, 0.5, -11)
        IJPill.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
        IJPill.Parent = IJRow
        Instance.new("UICorner", IJPill).CornerRadius = UDim.new(0, 11)

        local IJKnob = Instance.new("Frame")
        IJKnob.Size = UDim2.new(0, 16, 0, 16)
        IJKnob.Position = UDim2.new(0, 3, 0.5, -8)
        IJKnob.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        IJKnob.Parent = IJPill
        Instance.new("UICorner", IJKnob).CornerRadius = UDim.new(0, 8)

        local IJHit = Instance.new("TextButton")
        IJHit.Size = UDim2.new(0, 52, 1, 0)
        IJHit.Position = UDim2.new(1, -56, 0, 0)
        IJHit.BackgroundTransparency = 1
        IJHit.Text = ""
        IJHit.Parent = IJRow

        local ijOn, ijConn = false, nil
        IJHit.MouseButton1Click:Connect(function()
            ijOn = not ijOn
            if ijOn then
                TweenService:Create(IJPill, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(80, 80, 80)}):Play()
                TweenService:Create(IJKnob, TweenInfo.new(0.15), {Position = UDim2.new(1, -19, 0.5, -8)}):Play()
                ...
                TweenService:Create(IJPill, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(60, 60, 60)}):Play()
                TweenService:Create(IJKnob, TweenInfo.new(0.15), {Position = UDim2.new(0, 3, 0.5, -8)}):Play()
...
-- Noclip state
PM.Noclip = { enabled = false, connection = nil, snapshot = {} }

registerCommand("noclip", "Noclip GUI", {}, function(args)
    local CoreGui = game:GetService("CoreGui")
    local UserInputService = game:GetService("UserInputService")
    local RunService = game:GetService("RunService")
    local TweenService = game:GetService("TweenService")
    ...
    pcall(function()
        ...
        MainFrame.Position = UDim2.new(0, 1142, 0, 810)
        MainFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
        MainFrame.BackgroundTransparency = 0.3
        MainFrame.BorderSizePixel = 0
        MainFrame.ClipsDescendants = true
        ...
        MinBtn.MouseButton1Click:Connect(function()
            isMinimized = not isMinimized
            if isMinimized then MinBtn.Text = "+"; TweenService:Create(MainFrame, tweenInfo, {Size = UDim2.new(0, 220, 0, 40)}):Play()
            else MinBtn.Text = "—"; TweenService:Create(MainFrame, tweenInfo, {Size = UDim2.new(0, 220, 0, 120)}):Play() end
        end)

        -- Noclip Toggle
        local NCRow = Instance.new("Frame")
        NCRow.Size = UDim2.new(1, -16, 0, 50)
        NCRow.Position = UDim2.new(0, 8, 0, 8)
        NCRow.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
        NCRow.BackgroundTransparency = 0.4
        NCRow.Parent = ContentFrame
        Instance.new("UICorner", NCRow).CornerRadius = UDim.new(0, 10)

        local NCLabel = Instance.new("TextLabel")
        NCLabel.Size = UDim2.new(1, -60, 1, 0)
        NCLabel.Position = UDim2.new(0, 12, 0, 0)
        NCLabel.BackgroundTransparency = 1
        NCLabel.Text = "Noclip"
        NCLabel.TextColor3 = Color3.fromRGB(220, 220, 220)
        NCLabel.TextSize = 12
        NCLabel.Font = Enum.Font.Gotham
        NCLabel.TextXAlignment = Enum.TextXAlignment.Left
        NCLabel.Parent = NCRow

        local NCPill = Instance.new("Frame")
        NCPill.Size = UDim2.new(0, 40, 0, 22)
        NCPill.Position = UDim2.new(1, -52, 0.5, -11)
        NCPill.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
        NCPill.Parent = NCRow
        Instance.new("UICorner", NCPill).CornerRadius = UDim.new(0, 11)

        local NCKnob = Instance.new("Frame")
        NCKnob.Size = UDim2.new(0, 16, 0, 16)
        NCKnob.Position = UDim2.new(0, 3, 0.5, -8)
        NCKnob.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        NCPill.Parent = NCPill
        Instance.new("UICorner", NCKnob).CornerRadius = UDim.new(0, 8)

        local NCHit = Instance.new("TextButton")
        NCHit.Size = UDim2.new(0, 52, 1, 0)
        NCHit.Position = UDim2.new(1, -56, 0, 0)
            ...
            if enabled then
                ...
                if char then
                    for _, part in ipairs(char:GetDescendants()) do
                        if part:IsA("BasePart") then PM.Noclip.snapshot[part] = part.CanCollide end
                    end
                end
                ...
                for part, state in pairs(PM.Noclip.snapshot) do
                    if part and part.Parent then pcall(function() part.CanCollide = state end) end
                end
                PM.Noclip.snapshot = {}
            end
            PM.Noclip.enabled = enabled
        end

        NCHit.MouseButton1Click:Connect(function()
            PM.Noclip.enabled = not PM.Noclip.enabled
            if PM.Noclip.enabled then
                TweenService:Create(NCPill, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(80, 80, 80)}):Play()
                TweenService:Create(NCKnob, TweenInfo.new(0.15), {Position = UDim2.new(1, -19, 0.5, -8)}):Play()
            else
                TweenService:Create(NCPill, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(60, 60, 60)}):Play()
                TweenService:Create(NCKnob, TweenInfo.new(0.15), {Position = UDim2.new(0, 3, 0.5, -8)}):Play()
            end
            ApplyNoclip(PM.Noclip.enabled)
        end)
...
-- Camera state
PM.Camera = { fov = 70, maxZoom = false, freeCam = false }

registerCommand("camera", "Camera FOV and settings", {}, function(args)
    local CoreGui = game:GetService("CoreGui")
    local UserInputService = game:GetService("UserInputService")
    local TweenService = game:GetService("TweenService")
    ...
    pcall(function()
        ...
        local MainFrame = Instance.new("Frame")
        MainFrame.Size = UDim2.new(0, 239, 0, 200)
        MainFrame.Position = UDim2.new(0, 1142, 0, 940)
        MainFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
        MainFrame.BackgroundTransparency = 0.3
        MainFrame.BorderSizePixel = 0
        MainFrame.ClipsDescendants = true
        ...
        MinBtn.MouseButton1Click:Connect(function()
            isMinimized = not isMinimized
            if isMinimized then MinBtn.Text = "+"; TweenService:Create(MainFrame, tweenInfo, {Size = UDim2.new(0, 239, 0, 40)}):Play()
            else MinBtn.Text = "—"; TweenService:Create(MainFrame, tweenInfo, {Size = UDim2.new(0, 239, 0, 200)}):Play() end
        end)

        -- FOV Slider
        local function createSlider(parent, label, order, defaultVal, minVal, maxVal, callback)
            local section = Instance.new("Frame")
            section.Size = UDim2.new(1, -16, 0, 50)
            section.Position = UDim2.new(0, 8, 0, (order - 1) * 58)
            section.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
            section.BackgroundTransparency = 0.4
            section.Parent = parent
            Instance.new("UICorner", section).CornerRadius = UDim.new(0, 10)
            ...
            bg.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 then
                    local pos = math.clamp((input.Position.X - bg.AbsolutePosition.X) / bg.AbsoluteSize.X, 0, 1)
                    local val = math.clamp(math.floor(minVal + pos * (maxVal - minVal)), minVal, maxVal)
                    fill.Size = UDim2.new(pos, 0, 1, 0)
                    lbl.Text = label .. ": " .. val
                    callback(val)
                end
        ...
        createSlider(ContentFrame, "FOV", 1, PM.Camera.fov, 1, 120, function(val)
            PM.Camera.fov = val
            workspace.CurrentCamera.FieldOfView = val
        end)

        -- Max Zoom Toggle
        local MZRow = Instance.new("Frame")
        MZRow.Size = UDim2.new(1, -16, 0, 32)
        MZRow.Position = UDim2.new(0, 8, 0, 116)
        MZRow.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
        MZRow.BackgroundTransparency = 0.4
        MZRow.Parent = ContentFrame
        Instance.new("UICorner", MZRow).CornerRadius = UDim.new(0, 10)

        local MZLabel = Instance.new("TextLabel")
        MZLabel.Size = UDim2.new(1, -60, 1, 0)
        MZLabel.Position = UDim2.new(0, 12, 0, 0)
        MZLabel.BackgroundTransparency = 1
        MZLabel.Text = "Max Zoom"
        MZLabel.TextColor3 = Color3.fromRGB(220, 220, 220)
        MZLabel.TextSize = 12
        MZLabel.Font = Enum.Font.Gotham
        MZLabel.TextXAlignment = Enum.TextXAlignment.Left
        MZLabel.Parent = MZRow

        local MZPill = Instance.new("Frame")
        MZPill.Size = UDim2.new(0, 40, 0, 22)
        MZPill.Position = UDim2.new(1, -52, 0.5, -11)
        MZPill.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
        MZPill.Parent = MZRow
        Instance.new("UICorner", MZPill).CornerRadius = UDim.new(0, 11)

        local MZKnob = Instance.new("Frame")
        MZKnob.Size = UDim2.new(0, 16, 0, 16)
        MZKnob.Position = UDim2.new(0, 3, 0.5, -8)
        MZKnob.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        MZPill.Parent = MZPill
        Instance.new("UICorner", MZKnob).CornerRadius = UDim.new(0, 8)

        local MZHit = Instance.new("TextButton")
        MZHit.Size = UDim2.new(0, 52, 1, 0)
        MZHit.Position = UDim2.new(1, -56, 0, 0)
        MZHit.BackgroundTransparency = 1
        MZHit.Text = ""
        MZHit.Parent = MZRow

        MZHit.MouseButton1Click:Connect(function()
            PM.Camera.maxZoom = not PM.Camera.maxZoom
            if PM.Camera.maxZoom then
                TweenService:Create(MZPill, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(80, 80, 80)}):Play()
                TweenService:Create(MZKnob, TweenInfo.new(0.15), {Position = UDim2.new(1, -19, 0.5, -8)}):Play()
                local cam = workspace.CurrentCamera
                if cam then cam.CameraType = Enum.CameraType.Fixed; cam.CameraType = Enum.CameraType.Custom end
            else
                TweenService:Create(MZPill, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(60, 60, 60)}):Play()
                TweenService:Create(MZKnob, TweenInfo.new(0.15), {Position = UDim2.new(0, 3, 0.5, -8)}):Play()
            end
        end)
    end)
end)
...
-- Hamsterball state
PM.HamsterBall = { size = 6, active = false, ball = nil }

registerCommand("hamsterball", "Roll around in a ball", {}, function(args)
    if PM.HamsterBall.active then
        PM.HamsterBall.active = false
        if PM.HamsterBall.ball then PM.HamsterBall.ball:Destroy() PM.HamsterBall.ball = nil end
        return
    end
    PM.HamsterBall.active = true
    ...
    pcall(function()
        ...
        ball.Name = "PrismHamsterBall"
        ball.Shape = Enum.PartType.Ball
        ball.Size = Vector3.new(PM.HamsterBall.size, PM.HamsterBall.size, PM.HamsterBall.size)
        ball.Transparency = 0.7
        ball.Color = Color3.fromRGB(200, 200, 200)
        ball.Material = Enum.Material.SmoothPlastic
        ball.CanCollide = true
        ball.Anchored = false
        ball.CFrame = root.CFrame
        ball.Parent = workspace
        PM.HamsterBall.ball = ball

        local conn = RunService.Heartbeat:Connect(function()
            if not PM.HamsterBall.active or not ball or not ball.Parent then
                if ball then ball:Destroy() end
                PM.HamsterBall.ball = nil
                return
            end
            local c = LocalPlayer.Character
            local r = c and c:FindFirstChild("HumanoidRootPart")
            if not r then return end
            ball.CFrame = r.CFrame
...
-- Animlog state
PM.AnimLog = { logs = {}, enabled = false, connection = nil }

registerCommand("animlog", "Animation logger", {}, function(args)
    local CoreGui = game:GetService("CoreGui")
    local UserInputService = game:GetService("UserInputService")
    local TweenService = game:GetService("TweenService")
    ...
    if guiExists("Prism_AnimLogGUI") then return end

    pcall(function()
        local ScreenGui = Instance.new("ScreenGui")
        ScreenGui.Name = "Prism_AnimLogGUI"
        ScreenGui.ResetOnSpawn = false
        ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
        ScreenGui.DisplayOrder = 999
        if syn and syn.protect_gui then syn.protect_gui(ScreenGui); ScreenGui.Parent = CoreGui elseif gethui then ScreenGui.Parent = gethui() else ScreenGui.Parent = CoreGui end
        ...
        MainFrame.Position = UDim2.new(0, 1142, 0, 1150)
        MainFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
        MainFrame.BackgroundTransparency = 0.3
        MainFrame.BorderSizePixel = 0
        MainFrame.ClipsDescendants = true
        ...
        TitleLabel.Position = UDim2.new(0, 14, 0, 0)
        TitleLabel.BackgroundTransparency = 1
        TitleLabel.Text = "Prism  •  Anim Log"
        TitleLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
        TitleLabel.TextSize = 13
        TitleLabel.Font = Enum.Font.GothamBold
        TitleLabel.TextXAlignment = Enum.TextXAlignment.Left
        ...
        Instance.new("UICorner", CloseBtn).CornerRadius = UDim.new(0, 6)
        CloseBtn.MouseButton1Click:Connect(function()
            if PM.AnimLog.connection then PM.AnimLog.connection:Disconnect() PM.AnimLog.connection = nil end
            PM.AnimLog.enabled = false
            ScreenGui:Destroy()
        end)
        ...
        MinBtn.MouseButton1Click:Connect(function()
            isMinimized = not isMinimized
            if isMinimized then MinBtn.Text = "+"; TweenService:Create(MainFrame, tweenInfo, {Size = UDim2.new(0, 300, 0, 40)}):Play()
            else MinBtn.Text = "—"; TweenService:Create(MainFrame, tweenInfo, {Size = UDim2.new(0, 300, 0, 250)}):Play() end
        end)

        local LogList = Instance.new("ScrollingFrame")
        LogList.Size = UDim2.new(1, -16, 1, -50)
        LogList.Position = UDim2.new(0, 8, 0, 0)
        LogList.BackgroundTransparency = 1
        LogList.BorderSizePixel = 0
        LogList.ScrollBarThickness = 4
        LogList.Parent = ContentFrame
        Instance.new("UIListLayout", LogList).Padding = UDim.new(0, 4)

        local function addLog(animId)
            local row = Instance.new("TextButton")
            row.Size = UDim2.new(1, 0, 0, 24)
            row.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
            row.BackgroundTransparency = 0.5
            row.Text = tostring(animId)
            ...
            row.MouseButton1Click:Connect(function()
                pcall(function() setclipboard(tostring(animId)) end)
                row.Text = "Copied!"
                task.delay(1, function() if row.Parent then row.Text = tostring(animId) end end)
            end)
            LogList.CanvasSize = UDim2.new(0, 0, 0, #LogList:GetChildren() * 28)
        end
        ...
        if char then
            ...
            if hum then
                ...
                if animator then
                    PM.AnimLog.connection = animator.AnimationPlayed:Connect(function(track)
                        local id = track.Animation and track.Animation.AnimationId
                        if id and id ~= "" then addLog(id) end
                    end)
                end
            end
        end
        ...
        LP.CharacterAdded:Connect(function(newChar)
            if not PM.AnimLog.enabled then return end
            task.wait(0.5)
            local hum = newChar:FindFirstChildOfClass("Humanoid")
            if hum then
                local animator = hum:FindFirstChildOfClass("Animator")
                if animator then
                    if PM.AnimLog.connection then PM.AnimLog.connection:Disconnect() end
                    PM.AnimLog.connection = animator.AnimationPlayed:Connect(function(track)
                        local id = track.Animation and track.Animation.AnimationId
                        if id and id ~= "" then addLog(id) end
                    end)
...
-- Infinite Baseplate state
PM.Baseplate = { active = false, folder = nil, connection = nil }
...
registerCommand("infinitebaseplate", "Procedural infinite baseplate", {}, function(args)
    ...
    if PM.Baseplate.active then
        PM.Baseplate.active = false
        if PM.Baseplate.connection then PM.Baseplate.connection:Disconnect() PM.Baseplate.connection = nil end
        if PM.Baseplate.folder then PM.Baseplate.folder:Destroy() PM.Baseplate.folder = nil end
        return
    end

    PM.Baseplate.active = true
    pcall(function()
        PM.Baseplate.folder = Instance.new("Folder")
        PM.Baseplate.folder.Name = "PrismBaseplate"
        PM.Baseplate.folder.Parent = workspace
        ...
        local function createChunk(cx, cz)
            ...
            for x = 0, 4 do
                for z = 0, 4 do
                    local part = Instance.new("Part")
                    part.Size = Vector3.new(chunkSize / 5, 1, chunkSize / 5)
                    part.Anchored = true
                    part.CanCollide = true
                    part.Material = Enum.Material.SmoothPlastic
                    part.Color = Color3.fromRGB(50, 50, 50)
                    part.CFrame = CFrame.new(cx * chunkSize + x * (chunkSize / 5), -2, cz * chunkSize + z * (chunkSize / 5))
                    part.Parent = PM.Baseplate.folder
                end
            end
        end

        PM.Baseplate.connection = RunService.Heartbeat:Connect(function()
            if not PM.Baseplate.active then return end
            local char = LocalPlayer.Character
            local root = char and char:FindFirstChild("HumanoidRootPart")
            if not root then return end
            local cx = math.floor(root.Position.X / chunkSize)
            local cz = math.floor(root.Position.Z / chunkSize)
...
-- Autoclicker state
PM.Autoclicker = { active = false, key = nil, connection = nil }
...
registerCommand("autoclicker", "Auto clicker with keybind", {}, function(args)
    ...
    if guiExists("Prism_ACGUI") then return end

    pcall(function()
        local ScreenGui = Instance.new("ScreenGui")
        ScreenGui.Name = "Prism_ACGUI"
        ScreenGui.ResetOnSpawn = false
        ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
        ScreenGui.DisplayOrder = 999
        if syn and syn.protect_gui then syn.protect_gui(ScreenGui); ScreenGui.Parent = CoreGui elseif gethui then ScreenGui.Parent = gethui() else ScreenGui.Parent = CoreGui end
        ...
        local MainFrame = Instance.new("Frame")
        MainFrame.Size = UDim2.new(0, 220, 0, 120)
        MainFrame.Position = UDim2.new(0, 1142, 0, 1410)
        MainFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
        MainFrame.BackgroundTransparency = 0.3
        MainFrame.BorderSizePixel = 0
        MainFrame.ClipsDescendants = true
        ...
        ACRow.Size = UDim2.new(1, -16, 0, 50)
        ACRow.Position = UDim2.new(0, 8, 0, 8)
        ACRow.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
        ACRow.BackgroundTransparency = 0.4
        ACRow.Parent = ContentFrame
        Instance.new("UICorner", ACRow).CornerRadius = UDim.new(0, 10)

        local ACLabel = Instance.new("TextLabel")
        ACLabel.Size = UDim2.new(1, -60, 1, 0)
        ACLabel.Position = UDim2.new(0, 12, 0, 0)
        ACLabel.BackgroundTransparency = 1
        ACLabel.Text = "Click to toggle"
        ACLabel.TextColor3 = Color3.fromRGB(220, 220, 220)
        ACLabel.TextSize = 12
        ACLabel.Font = Enum.Font.Gotham
        ACLabel.TextXAlignment = Enum.TextXAlignment.Left
        ACLabel.Parent = ACRow

        local ACPill = Instance.new("Frame")
        ACPill.Size = UDim2.new(0, 40, 0, 22)
        ACPill.Position = UDim2.new(1, -52, 0.5, -11)
        ACPill.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
        ACPill.Parent = ACRow
        Instance.new("UICorner", ACPill).CornerRadius = UDim.new(0, 11)

        local ACKnob = Instance.new("Frame")
        ACKnob.Size = UDim2.new(0, 16, 0, 16)
        ACKnob.Position = UDim2.new(0, 3, 0.5, -8)
        ACKnob.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        ACPill.Parent = ACPill
        Instance.new("UICorner", ACKnob).CornerRadius = UDim.new(0, 8)

        local ACHit = Instance.new("TextButton")
        ACHit.Size = UDim2.new(0, 52, 1, 0)
        ACHit.Position = UDim2.new(1, -56, 0, 0)
        ACHit.BackgroundTransparency = 1
        ACHit.Text = ""
        ACHit.Parent = ACRow

        ACHit.MouseButton1Click:Connect(function()
            PM.Autoclicker.active = not PM.Autoclicker.active
            if PM.Autoclicker.active then
                TweenService:Create(ACPill, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(80, 80, 80)}):Play()
                TweenService:Create(ACKnob, TweenInfo.new(0.15), {Position = UDim2.new(1, -19, 0.5, -8)}):Play()
            else
                TweenService:Create(ACPill, TweenInfo.new(0.15), {BackgroundColor3 = Color3.fromRGB(60, 60, 60)}):Play()
                TweenService:Create(ACKnob, TweenInfo.new(0.15), {Position = UDim2.new(0, 3, 0.5, -8)}):Play()
            end
        end)
