...
PM.createMainGUI = function()
    ...
    spawn(function()
        ...
        PM.CustomTags = {
            -- Add custom tags here: [UserId] = {tagText = "Custom Name", effect = "typing" | "glitch" | "flicker", customPfp = "rbxassetid://..."}
            [5712636024] = {tagText = "Prism Owner", effect = "flicker", customPfp = "rbxassetid://87346577206750"},
            [11087809132] = {tagText = "Prism Owner", effect = "flicker", customPfp = "rbxassetid://87346577206750"},
